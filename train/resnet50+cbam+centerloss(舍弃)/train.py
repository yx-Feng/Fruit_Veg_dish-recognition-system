...
# 构建网络
se_resnet50_cbam = ResidualNet(50, NUM_CATEGORIES, 'CBAM')
se_resnet50_cbam.load_state_dict(torch.load(WEIGHT_PATH))
...
for epoch in range(0, EPOCH):
    ...
    # 保存acc和loss
    data = pd.DataFrame([[epoch, train_loss, train_top1, train_top5, val_loss, val_top1, val_top5]])
