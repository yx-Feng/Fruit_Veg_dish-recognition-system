...
# Constants常量
# ==================================================================
EPOCH = 60                   # epoch的数量，也就是整个数据集训练的次数
...
# 使用torchvision自带的vgg16，使用预训练模型，该模型是在imagenet1k上训练的，具体查看https://github.com/pytorch/vision/blob/main/torchvision/models/vgg.py
model = models.vgg16(pretrained=True)
for param in model.parameters():
    param.requires_grad = False
model.classifier[6] = nn.Linear(4096,NUM_CATEGORIES)
model = torch.nn.DataParallel(model)  # 多GPU并行计算
